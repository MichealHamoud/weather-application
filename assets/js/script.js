...
$SearchBtn.on('click', function (event) {
    ...
    fetch('https://api.openweathermap.org/data/2.5/weather?q=' + Input.value + '&appid=20516ee7fdcc8a804bdcda9f63d8d30a')
        ...
        .then(data => {
            ...
            Wind.innerHTML = ("Wind: " + windValue + " Kph");
    ...
    fetch('https://api.openweathermap.org/data/2.5/forecast?q=' + Input.value + '&units=imperial&appid=20516ee7fdcc8a804bdcda9f63d8d30a')
        ...
        .then(data => {
            console.log(data);
                ...
                document.getElementById("Temp1" ).innerHTML = 'Temp: ' + Number(data.list[0].main.temp).toFixed(0) + "°C";
                document.getElementById("Wind1").innerHTML = 'Wind: ' + Number(data.list[0].wind.speed) + " Kph";
                ...
                document.getElementById("Temp2" ).innerHTML = 'Temp: ' + Number(data.list[8].main.temp).toFixed(0) + "°C";
                document.getElementById("Wind2").innerHTML = 'Wind: ' + Number(data.list[8].wind.speed) + " Kph";
                ...
                document.getElementById("Temp3" ).innerHTML = 'Temp: ' + Number(data.list[16].main.temp).toFixed(0) + "°C";
                document.getElementById("Wind3").innerHTML = 'Wind: ' + Number(data.list[16].wind.speed) + " Kph";
                ...
                document.getElementById("Temp4" ).innerHTML = 'Temp: ' + Number(data.list[24].main.temp).toFixed(0) + "°C";
                document.getElementById("Wind4").innerHTML = 'Wind: ' + Number(data.list[24].wind.speed) + " Kph";
                ...
                document.getElementById("Temp5" ).innerHTML = 'Temp: ' + Number(data.list[32].main.temp).toFixed(0) + "°C";
                document.getElementById("Wind5").innerHTML = 'Wind: ' + Number(data.list[32].wind.speed) + " Kph";
